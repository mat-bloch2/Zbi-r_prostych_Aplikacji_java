...
public class wizytuwki
{
    ...
    public void wizytuwki(String Sciezka_do_Pliku)
    {
        odczytajWizytuwke(Sciezka_do_Pliku);
    }
    ...
    public void ZapiszWizytuwkeDoPliku(String sciezka)
    {
        PrintWriter zapis;
        try
        {
    ...
    public void odczytajWizytuwke(String SciezkaDoPliku)
    {
        BufferedReader odczyt ;
        try {
            odczyt =new BufferedReader(new FileReader(SciezkaDoPliku));
